        ...
        <div className="bg-[#0C3229] text-white rounded-3xl p-8 sm:p-12 mb-16 shadow-xl relative overflow-hidden border border-[#D3B15F]/30">
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <p className="text-slate-200 text-base sm:text-lg leading-relaxed">
              {companyConfig.brandName} was founded with a singular purpose: to
              remove friction from local trade, giving everyday buyers access
              to honest pricing and providing micro-enterprises with the tools
              to thrive.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              To build Ghana&apos;s most trustworthy, accessible, and
              user-friendly digital marketplace where anyone can securely
              trade goods and services with complete transparency.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              We eliminate unnecessary middlemen and excessive commission
              markups, allowing buyers and sellers to connect, chat, and deal
              directly with total freedom.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Through merchant profile verification, account moderation, and
              clear safety guidance, we maintain a secure commerce environment
        ...
        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-xs space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
            ...
            <div className="p-4 bg-[#F7F6F2] rounded-xl border border-slate-200">
              ...
              <div className="text-sm font-extrabold text-[#171A18]">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-between bg-[#0C3229] text-white p-6 rounded-2xl gap-4 border border-[#D3B15F]/30">
            <div>
              <div className="text-lg font-extrabold">
                Ready to explore the Agape e-Mall app?
              </div>

              <div className="text-xs text-slate-300">
                Download free today on iOS & Android.
              </div>
            </div>
